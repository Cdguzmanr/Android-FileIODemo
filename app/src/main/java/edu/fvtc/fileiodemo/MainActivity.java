...
public class MainActivity extends AppCompatActivity {
    ...
    private void createActors() {
        ...
        actors.add(new Actor(2,"Paul","Rodd"));
        actors.add(new Actor(3,"Brat","Pitt"));
        actors.add(new Actor(4,"Angelina","Jolie"));
        actors.add(new Actor(5,"Denzel","Washington"));
        actors.add(new Actor(6,"Meryl","Streep"));
    }
